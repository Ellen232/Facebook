...
<div id="header_wrapper"> 
    <div id="header"> 
        ...
        <li>
            <link rel="stylesheet" type="text/css" href="facebook2.php">
...
<div id="wrapper"> 
        ...
        <div id="div2"> 
        <h1>Sign Up</h1> 
        <p><span class="subtext">It's quick and easy.</span></p> 
            <li>
            ...
            <br>
            <p><span class="gray">Birthday</span></p> 
            <li> 
                <select name="day">
     ...
     <?php 
        ...
        $connect = mysqli_connect($servername,$username,$password,$databasename);
         ...
         if(isset($_POST['SignUp'])){
            ...
            $sqlInsert = "INSERT INTO tblfacebook(fname,lname, email, password, day, month, year, gender)
            VALUES('$fname','$lname','$email','$password', '$day', '$month', '$year','$gender')";
            $query = mysqli_query($connect,$sqlInsert);
            if ($query == TRUE) {
                echo "<strong>You are registered successfully</strong>";
            }else{
                echo "<strong>Required fields are missing.</strong>";
